...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/welcome_contact.css')); ?>">
...
<style>
    .swal2-icon.swal2-success {
        color: #28a745; /* Change to your desired success icon color */
    }

    .swal2-icon.swal2-error {
        color: #dc3545; /* Change to your desired error icon color */
    }

    .swal2-icon.swal2-warning {
        color: #ffc107; /* Change to your desired warning icon color */
    }

    .swal2-icon.swal2-info {
        color: #17a2b8; /* Change to your desired info icon color */
    }
</style>
