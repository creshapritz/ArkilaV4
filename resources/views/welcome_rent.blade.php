...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/welcome_rent.css')); ?>">
</head>
        ...
        <div class="navbar-right">
            ...
            <div class="sidebar">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('welcome_partner') }}"><i
                                class='bx bx-user-plus'></i><span>Partnership</span></a></li>
