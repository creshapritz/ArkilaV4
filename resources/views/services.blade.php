    ...
    <div>
        ...
        <div class="services-content1">
            ...
            <div class="rental-buttons">
                <button class="rental-button" onclick="window.location.href='{{ route('self_drive') }}' ">Self Drive</button>
                <button class="rental-button" onclick="window.location.href='{{ route('with_driver') }}'">With Driver</button>
            </div>
        </div>
        ...
        <div class="services-content3">
            ...
            <div class="services-contents3-text">
                ...
                <p>Relax and enjoy the ride with Arkila’s Car Rental with Driver service. Perfect for stress-free travel, our professional drivers ensure a safe, comfortable, and convenient journey, allowing you to focus on what matters most. Ideal for business trips, special occasions, or simply enjoying a hassle-free experience on the road.
                </p>
                <p><br><br>With ARKILA, you’re in control of the journey.</p>
