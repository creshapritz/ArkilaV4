    ...
    <div class="profile-management">
        ...
        <form class="profile-form">
            <div class="form-row">
                ...
                value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->first_name : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="middle-name">Middle Name</label>
                <input type="text" id="middle-name" name="middle-name"
                value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->middle_name : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="last-name">Last Name</label>
                <input type="text" id="last-name" name="last-name"
                value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->last_name : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="extension-name">Extension Name</label>
                <input type="text" id="extension-name" name="extension-name"
                value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->extension_name : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="age">Age</label>
                <input type="text" id="age" name="age" value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->age : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="contact_number">Contact Number</label>
                <input type="text" id="contact_number" name="contact_number"
                value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->contact_number: '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="email">Email</label>
                <input type="email" id="email" name="email" value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->email : '' }}" readonly>
            </div>
            <div class="form-row">
                <label for="birthday">Birthday</label>
                <input type="date" id="birthday" name="birthday" value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->dob : '' }}" readonly>
            </div>
            ...
            <div class="emergency-contact-section">
                ...
                <div class="emergency-contact-row">
                    ...
                    value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->emergency_contact : '' }}" readonly>
                    ...
                    value="{{ Auth::guard('client')->user() ? Auth::guard('client')->user()->emergency_contact_relationship : '' }}" readonly>
                </div>
            </div>
        </form>
