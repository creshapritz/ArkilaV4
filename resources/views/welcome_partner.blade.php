...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/welcome_partner.css')); ?>">
                ...
                <div class="text-container1">
                    ...
                    <div class="button-container">
                        <button class="partner-button"
                            onclick="window.open('{{ asset('documents/Arkila_Requirements.pdf') }}', '_blank')">
                            Requirements
                        </button>

                        <button class="partner-button" onclick="window.open('{{ asset('documents/Partnership_Proposal_Form.pdf') }}', '_blank')">Send Application</button>
                    </div>
                </div>
